...
from app import Horoscope, Message, Command, app, db
...
def static(message):
    ...
    mes = Message(chat_id=chat_id, username=username, text=text_mes)
...
def stat_command(message):
    ...
    mes = Command(chat_id=chat_id, username=username, command=command)
